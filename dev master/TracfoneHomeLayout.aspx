...
<asp:Content ContentPlaceholderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <SharePointWebControls:CssRegistration name="<% $SPUrl:~sitecollection/Style Library/~language/Themable/Core Styles/tracfone-layout.css %>" runat="server"/>
...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	<div class="welcome blank-wp">
		...
		<div class="ms-table ms-fullWidth">
            <div class="ms-table ms-fullWidth">
					<div class="cell-margin tableCol-33 tf-col-33">
						<WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_TopLeft%>" ID="TopLeftColumn" />
					</div>
					<div class="cell-margin tableCol-66 tf-col-66 chart-contrainer">
                        <div class="ms-table ms-fullWidth">
					    <div class="cell-margin  tf-col-50">
						    <WebPartPages:WebPartZone runat="server" Title="Top Middle" ID="TopMiddle" />
					    </div>
					    <div class="cell-margin tf-col-50">
						    <WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_TopRight%>" ID="TopRightColumn" />
					    </div>
                            </div>
					</div>
				</div>
            <div class="ms-table ms-fullWidth">
					<div class="cell-margin tableCol-66 tf-col-66">
             ...
             <div class="ms-table ms-fullWidth">
					<div class="cell-margin tableCol-33 tf-col-33">
						<WebPartPages:WebPartZone runat="server" Title="Bottom Left" ID="BottomLeftColumn" />
					</div>
					<div class="cell-margin tableCol-66 tf-col-66">
						<WebPartPages:WebPartZone runat="server" Title="Bottom Right" ID="BottomRightcolumn" />
					</div>
				</div>
            <div class="ms-table ms-fullWidth">
